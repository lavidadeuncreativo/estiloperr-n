...
export const homepageBlocks: HomepageBlock[] = [
  ...
  {
    id: 'hb-9', block_type: 'campaign',
    title: 'Línea OTSO',
    subtitle: 'Streetwear icónico para perrhijos con actitud urbana.',
    cta_text: 'Ver colección', cta_url: '/colecciones/otso',
    image_url: '/products/GAP foto 3.jpg', secondary_image_url: '/products/GAP foto 4.jpg',
    position: 6, is_visible: true, theme: 'blue', bg_color: '#5568AF',
    created_at: '2026-01-01', updated_at: '2026-03-01',
  },
  {
    id: 'hb-10', block_type: 'campaign',
    title: 'The North Fetch',
    subtitle: 'Explora el mundo con estilo premium y protección.',
    cta_text: 'Ver colección', cta_url: '/colecciones/the-north-fetch',
    image_url: '/products/TNF foto 2.jpg', secondary_image_url: '/products/TNF foto 3.jpg',
    position: 7, is_visible: true, theme: 'stone', bg_color: '#E8E1D8',
    created_at: '2026-01-01', updated_at: '2026-03-01',
  },
  {
    id: 'hb-11', block_type: 'campaign',
    title: 'Streetwear Esencial',
    subtitle: 'Básicos que no pueden faltar en su clóset.',
    cta_text: 'Ver colección', cta_url: '/colecciones/streetwear-esencial',
    image_url: '/products/IMG_1263.PNG', secondary_image_url: '/products/HD foto 1.jpg',
    position: 8, is_visible: true, theme: 'pink', bg_color: '#F8C9DD',
    created_at: '2026-01-01', updated_at: '2026-03-01',
  },
  {
    ...
    position: 9, is_visible: true, theme: 'white',
  ...
  },
  {
    ...
    position: 10, is_visible: true, theme: 'aqua', bg_color: '#CEEEAE',
    created_at: '2026-01-01', updated_at: '2026-03-01',
  },
];
